  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      <span className="text-xl mb-12">
        Rate <span className="font-semibold">Yuchen</span>&apos;s Answer.
      </span>
      <div className="flex items-center gap-5">
        <div className="flex flex-col">
          ...
          <textarea
            className="w-96 h-36 px-3 py-2 rounded-xl border-2 border-neutral-200 font-medium mb-3 resize-none pointer-events-none"
            value="我喜欢打篮球。"
          />
        </div>
        <div className="flex flex-col">
